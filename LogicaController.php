...
class LogicaController extends Controller {
      ...
      public function stock (request $request){
		...
		$codigos[]=["Codigo"=>30172112, "Nombre"=>"Componente de operador de puerta de garaje","valor"=>5000, "clase"=>"A", "tipo"=>1];
		$codigos[]=["Codigo"=>30172113, "Nombre"=>"Accesorio de operador de puerta de garaje","valor"=>5000, "clase"=>"A", "tipo"=>1];
		...
		$codigos[]=["Codigo"=>30171520, "Nombre"=>"Loop de puerta y ventana","valor"=>45000, "clase"=>"A", "tipo"=>1];
           ...
           foreach ($codigos as $iterador => $value) {
                          
                          
                           foreach ($value as $categoria => $values){
                          
                                 
                                echo $codigos[$iterador]['Codigo'],"<br>"; 
                                echo $codigos[$iterador]['Nombre'],"<br>";
                                echo $codigos[$iterador]['valor'],"<br>";
                                echo $codigos[$iterador]['clase'],"<br>";
                                echo $codigos[$iterador]['tipo'],"<br>";
       ...
       public function compra (request $request){
                ...
                $nombreRep = $request -> input('nombre');   
                $apellidoRep= $request -> input('apellido');   
